...
Меня зовут Кристина и я Python-разработчик, работаю ведущим специалистом информационного отдела. Специализируюсь на Django, создаю полноценные веб-приложения.
